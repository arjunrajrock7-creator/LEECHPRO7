...
desp_dict = {
    ...
    "usess": [
        f'User Session is Telegram Session used to Download Private Contents from Private Channels with no compromise in Privacy, Build with Encryption.\n{"<b>Warning:</b> This Bot is not secured. We recommend asking the group owner to set the Upstream repo to the Official repo. If it is not the official repo, then ⚡𝗛𝗘𝗠𝗔𝗡𝗧𝗛⚡ is not responsible for any issues that may occur in your account." if config_dict["UPSTREAM_REPO"] != "https://github.com/arjunrajrock7-creator/LEECHPRO7" else "Bot is Secure. You can use the session securely."}',
