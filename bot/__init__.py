...
from asyncio import Lock, new_event_loop, set_event_loop, iscoroutine
...
if len(USER_SESSION_STRING) != 0:
    ...
    try:
        ...
        res = user.start()
        if iscoroutine(res):
            bot_loop.run_until_complete(res)
...
LEECH_FILENAME_AUTORENAME = environ.get("LEECH_FILENAME_AUTORENAME", "")
if len(LEECH_FILENAME_AUTORENAME) == 0:
    LEECH_FILENAME_AUTORENAME = ""
...
config_dict = {
    ...
    "FFMPEG_THREADS": environ.get("FFMPEG_THREADS", ""),
}
